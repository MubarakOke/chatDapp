...
const Chat = () => {
  ...
  const { loading, data: conversationList } = useGetConversationList();
  const { loading: profileLoading, data: profile} = useGetProfile();
...
//   const loading = false;
  ...
  return (
    <div className="flex flex-col h-screen border-t text-white">
      <div className="border-b">
          <Header />
      </div>
      <div className="flex-1 flex min-h-0">
        <div className="hidden flex flex-col min-h-0 border-r md:flex">
          <button className="text-center px-4 py-3 border text-sm">
            Message New user
          </button>
              ...
              <div className="grid gap-2 p-4">
                {
                  loading ? (<h1>Loading...</h1>) :
                      ...
                      conversationList.map((name, index) => {
                        return (
